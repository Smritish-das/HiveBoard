    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "!font-medium !text-sm !bg-[#292E4E] hover:!bg-[#3A4070] hover:!border-transparent !transition-colors duration-300",
        ...
        dropdown: cn(" bg-[#292E4E] absolute inset-0 opacity-0", defaultClassNames.dropdown),
        ...
        day: cn(
          ...
          "px-1", // ✅ horizontal spacing between days
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[selected-single=true]:text-secondary",

        // Additional spacing for text clarity
